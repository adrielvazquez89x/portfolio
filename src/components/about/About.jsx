    ...
    return (
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-2 gap-8'>
            <Bio >
                ...
                <p>
                    I'm Adriel Alejandro Vazquez, and I'm currently expanding my knowledge of Frontend development. I completed a Frontend development course at Coderhouse,
                    and I'm also going through the entrance course for the Técnico Universitario en Programación degree at Universidad Tecnológica Nacional (UTN). <br /> <br />
                    ...
                    Outside of coding, I have a passion for music and play the guitar. Video games are also a big part of my life.
